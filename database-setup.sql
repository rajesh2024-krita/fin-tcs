...
('superadmin', 'AQAAAAEAACcQAAAAEGJZmEqXNzXZ1s8G3J8iNOXHZX9XL2YhQa3JWMK8JMZaNvWlJ8wEz3s1KF4cGD9tpw==', 'SuperAdmin', NULL, 1);

-- Insert Sample Societies
INSERT INTO Societies (Name, RegistrationNo, Address, City, State, PinCode, Phone, Email, ContactPerson, EstablishedDate) VALUES 
('ABC Cooperative Society', 'REG001', '123 Main Street', 'Mumbai', 'Maharashtra', '400001', '9876543210', 'abc@society.com', 'John Doe', '2020-01-15'),
('XYZ Credit Society', 'REG002', '456 Park Avenue', 'Delhi', 'Delhi', '110001', '9876543211', 'xyz@society.com', 'Jane Smith', '2019-03-20');

-- Insert Society Admin Users (Password: Admin@123)
INSERT INTO Users (Username, PasswordHash, Role, SocietyId, IsActive) VALUES 
